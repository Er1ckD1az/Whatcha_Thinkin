...
BUFFER_SIZE = 512  # Power of 2 is best for FFT
EEG_buffer = deque(maxlen=BUFFER_SIZE)
time_buffer = deque(maxlen=BUFFER_SIZE)

# Sampling parameters - Updated to match Arduino's 250Hz
sampling_rate = 250 
...
def update(frame):
    ...
    # Apply additional bandpass filtering for analysis (already have basic filtering on Arduino)
